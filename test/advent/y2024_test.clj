  ...
  (testing "part 1"
    (testing "sample"
      (is (= (solve-day-11-part-1 "125 17")
             55312
             (solve-day-11-part-1-map "125 17")))))
  (testing "puzzle"
    (is (= (solve-day-11-part-1 (puzzle/in 2024 11))
           199946
           (solve-day-11-part-1-map (puzzle/in 2024 11))
           )))
  (comment
    ...
    ({0 1}
     ...
     {2 2, 0 1, 4 1}
     {4048 2, 1 1, 8096 1}
     {40 2, 48 2, 2024 1, 80 1, 96 1}
     {4 4, 0 3, 8 3, 20 1, 24 1, 9 1, 6 1}
     {8096 4, 1 3, 16192 3, 2 2, 0 1, 4 1, 18216 1, 12144 1}
     {1 1, 36869184 1, 4048 2, 24579456 1, 8096 1, 32772608 3, 2024 3, 96 4, 80 4}))
  (testing "part 2"
